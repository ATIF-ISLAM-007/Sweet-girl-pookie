    ...
    <div className="w-full max-w-4xl mx-auto grid grid-cols-1 md:grid-cols-2 gap-8 items-center px-6 py-12">
      <div className="space-y-6">
        ...
        <div className="mt-4">
          <button
            onClick={toggle}
            className="inline-flex items-center gap-3 px-5 py-2 rounded-full border border-slate-200/10 bg-white/3 backdrop-blur text-white"
          >
            {open ? 'Close' : 'Open it'}
          </button>
        </div>
      ...
      <div
        ref={cardRef}
        className="relative rounded-2xl overflow-hidden shadow-2xl bg-gradient-to-br from-[#071026] to-[#081726]"
        style={{ height: '420px', '--cx': '50%', '--cy': '52%' }}
      >
        {/* Image */}
        <div
